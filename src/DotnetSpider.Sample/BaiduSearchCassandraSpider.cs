...
//			AddPipeline(new CassandraEntityPipeline("Host=127.0.0.1"));
...
//		[TableInfo("baidu", "baidu_search", Indexs = new[] { "Keyword" })]
//		[EntitySelector(Expression = ".//div[@class='result']", Type = SelectorType.XPath)]
//		private class BaiduSearchEntry : CassandraSpiderEntity
//		{
//			[Field(Expression = "Keyword", Type = SelectorType.Enviroment, Length = 200)]
