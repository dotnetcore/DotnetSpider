...
namespace DotnetSpider.Sample
{
	...
	public class GSXSpider : EntitySpiderBuilder
	{
		...
		{
			var cookieThief = new CommonCookieInterceptor
			{
			...
			context.AddEntityType(typeof(主页), new TargetUrlExtractor
			{
				Patterns = new List<string> { @"http://i\.genshuixue\.com/main[^/]*$" },
				KeepOrigin = false
			});
			context.AddEntityType(typeof(订单列表项));
