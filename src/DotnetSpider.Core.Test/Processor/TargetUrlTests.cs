...
namespace DotnetSpider.Core.Test.Processor
{
	public class TargetUrlTests
	{
		...
		public void UrlVerifyAndExtract1()
		{
			...
			Page page = new Page(new Request("http://www.cnblogs.com/", 0, null), ContentType.Html);
			page.Content = html;
		...
		public void UrlVerifyAndExtract4()
		{
			...
			Page page = new Page(new Request("http://www.cnblogs.com/sitehome/p/2/", 0, null), ContentType.Html);
			page.Content = html;
