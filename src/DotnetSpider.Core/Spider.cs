...
namespace DotnetSpider.Core
{
    ...
    public class Spider : ISpider, ISpeedMonitor
    {
        ...
        {
            return new Spider(site, Guid.NewGuid().ToString("N"), null, null, new QueueDuplicateRemovedScheduler(),
                pageProcessors);
        }
        ...
        /// <param name="scheduler"></param>
        /// <param name="userid"></param>
        protected Spider(Site site, string identity, string userid, string taskGroup, IScheduler scheduler,
