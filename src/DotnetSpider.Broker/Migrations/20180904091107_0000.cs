    ...
    public partial class _0000 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(nullable: false),
                    NodeType = table.Column<string>(maxLength: 10, nullable: false),
                    ...
                    OperatingSystem = table.Column<string>(maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FreeMemory = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(nullable: false),
                    Identity = table.Column<Guid>(nullable: false),
                    Consuming = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastModificationTime = table.Column<DateTime>(nullable: true),
                    LastModifierUserId = table.Column<long>(nullable: true),
                    FullClassName = table.Column<string>(maxLength: 200, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Worker_FullClassName_ConnectionId",
                table: "Worker",
                columns: new[] { "FullClassName", "ConnectionId" },
                unique: true);
        }
