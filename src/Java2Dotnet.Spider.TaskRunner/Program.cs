...
namespace Java2Dotnet.Spider.ScriptsConsole
{
	public class Program
	{
		...
		public static void Main(string[] args)
		{
			...
			manager.AddTestTask(testUserId, TaskJson.Replace("USER_ID", testUserId));
