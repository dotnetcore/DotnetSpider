...
namespace DotnetSpider.Tests
{
    public partial class DataParserTests
    {
        ...
        public async Task ParseEntity()
        {
            ...
            var dataContext = new DataContext(null, new SpiderOptions(), request, new Response
            {
            ...
            extractor.SetHtmlSelectableBuilder();
        ...
        public async Task SingleEntitySelector()
        {
            ...
            var dataContext =
                new DataContext(null, new SpiderOptions(), request,
                    new Response
                    {
                        Content = new ResponseContent {Data = Encoding.UTF8.GetBytes(Html)}
                    });
