...
//                    if (tmp.Length == 2)
//                    {
//                        if (RegexHelper.IpAddress.IsMatch(tmp[0]) && int.TryParse(tmp[1], out _))
//                        {
//                            _proxy = v;
//                            return;
//                        }
...
//                    string[] pathsToProfiles =
//                        Directory.GetDirectories(path, "*.webdriver", SearchOption.TopDirectoryOnly);
//                    var profile = pathsToProfiles.Length == 1
//                        ? new FirefoxProfile(pathsToProfiles[0], false)
//                        : new FirefoxProfile();
...
//                        string.IsNullOrWhiteSpace(Framework.ChromeDriverPath)
//                            ? AppDomain.CurrentDomain.BaseDirectory
//                            : Framework.ChromeDriverPath);
//                    cds.HideCommandPromptWindow = true;
//                    ChromeOptions opt = new ChromeOptions();
//                    if (!option.LoadImage)
//                    {
//                        opt.AddUserProfilePreference("profile",
//                            new {default_content_setting_values = new {images = 2}});
//                    }
//
//                    if (!string.IsNullOrEmpty(option.Proxy))
//                    {
