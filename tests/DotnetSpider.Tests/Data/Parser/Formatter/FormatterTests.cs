...
namespace DotnetSpider.Tests.Data.Parser.Formatter
{
	...
	public class FormatterTests
	{
		...
		public void RegexFormatterTest()
		{
			...
			var formatter1 = new RegexFormatter { False = "F", ValueWhenNull = "Y", Pattern = "很抱歉", True = "Y" };
			var str1 = "";
			Assert.Equal("F", formatter1.Format(str1));

			var formatter2 = new RegexFormatter { False = "F", ValueWhenNull = "F", Pattern = "很抱歉", True = "Y" };
		...
		public void CharacterCaseFormatterTest()
		{
			...
			var formatter3 = new CharacterCaseFormatter { ToUpper = false, ValueWhenNull = "OK" };
